...
public class FileConstant {
    ...
    public static final String DIRECTORY_CREATED = "Created directory for: "; //for debugging etc.
    public static final String DEFAULT_USER_IMAGE_PATH = "/user/image/profile/";
    public static final String FILE_SAVED_IN_FILE_SYSTEM = "Saved file in file system by name: "; //for debugging etc.
    public static final String DOT = ".";  // seperation between filename and extension
