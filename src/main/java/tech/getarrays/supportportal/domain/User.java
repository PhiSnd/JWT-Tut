package tech.getarrays.supportportal.domain;
...
@Entity
public class User implements Serializable {  // This class is gonna be going from java class to a stream that can be saved in database
    @Id
