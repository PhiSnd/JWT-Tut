package tech.getarrays.supportportal.enumeration;

import tech.getarrays.supportportal.constant.Authority;
...
public enum Role {
    ...
    Role(String ... authorities) {//takes any number of authorities
